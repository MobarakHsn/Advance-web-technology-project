...
class admin_controller extends Controller
{
    ...
    public function AdminRegistrationPost(Request $req)
    {
        ...
        try
        {
            ...
            if($check->fails()){
                return response()->json(["status"=>2,"errors"=>$check->errors()],200);
            }
            ...
            if(!$uc->save())
            {
                return response()->json(["status"=>3,"message"=>"Error in registration please try again later!"],200);
            }
            ...
            if(!$uinfo->save())
            {
                return response()->json(["status"=>3,"message"=>"Error in registration please try again later!"]);
            }
            return response()->json(["status"=>1,"uc_id"=>$uc->id,"message"=>"Admin successfully registered"],200);
        }
        catch(\Exception $e)
        {
            return response()->json([
